...
export default function CreateRolePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const json = await res.json();
      if (json.success) { toast("Role created successfully!", "success"); router.push("/admin/roles"); }
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-4">
        <Link href="/admin/roles"><Button variant="ghost" size="sm" className="gap-2 text-slate-600 dark:text-slate-400"><ArrowLeft className="h-4 w-4" />Back</Button></Link>
        <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          <Link href="/admin/roles"><Button type="button" variant="outline">Cancel</Button></Link>
