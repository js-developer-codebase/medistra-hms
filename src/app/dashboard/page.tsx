...
export default function DashboardPage() {
  ...
  const quickActions = [
    { title: "Add New Patient", href: "/patients/add", icon: UserPlus, color: "bg-emerald-600 hover:bg-emerald-700 text-white" },
    { title: "Book Appointment", href: "/appointments/book", icon: CalendarPlus, color: "bg-teal-600 hover:bg-teal-700 text-white" },
    { title: "New Admission", href: "/admissions/new", icon: PlusCircle, color: "bg-cyan-600 hover:bg-cyan-700 text-white" },
    { title: "Create Invoice", href: "/billing/create", icon: FilePlus, color: "bg-slate-800 hover:bg-slate-900 text-white dark:bg-slate-700 dark:hover:bg-slate-600" },
  ];

  const recentPatients = [
    { name: "Sarah Jenkins", id: "P-9042", doctor: "Dr. Alex Rivera", status: "Admitted", time: "10 mins ago" },
    { name: "Michael Vance", id: "P-9043", doctor: "Dr. Emily Zhang", status: "Outpatient", time: "25 mins ago" },
    { name: "Robert Thorne", id: "P-9044", doctor: "Dr. Marcus Vance", status: "ICU", time: "1 hour ago" },
    { name: "Elena Rostova", id: "P-9045", doctor: "Dr. Sophia Patel", status: "Discharged", time: "2 hours ago" },
  ];
